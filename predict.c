            ...
            while(P[i].Pos[j] < 0)
            {
                ...
                if(j==0)
                {
                    ...
                    if(P[i].Type==0)
                    {
                        ...
                        SphP[i].B[BOX_SHEARING_PHI_COORDINATE] -= Shearing_Box_B_Offset * P[i].Mass / SphP[i].Density;
                        SphP[i].BPred[BOX_SHEARING_PHI_COORDINATE] -= Shearing_Box_B_Offset * P[i].Mass / SphP[i].Density;
#endif
                    }
#if (BOX_SHEARING > 1)
